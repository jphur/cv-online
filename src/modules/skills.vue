...
<template>
    <section class="skills" id="skills">
        <div class="skills__container">
            <h2 class="section-title"><span class="section-number">04.</span> Conocimientos</h2>

            <div class="skills__grid">
                <div v-for="(category, index) in skills" :key="index" class="skills__category">
                    ...
                    <div class="skills__items">
                        <div v-for="skill in category.items" :key="skill.name" class="skills__item">
                            ...
                            <div class="skills__bar">
                                <div class="skills__bar-fill" :style="{ width: skill.level + '%' }"></div>
                            </div>
                        </div>
                    </div>
                </div>
